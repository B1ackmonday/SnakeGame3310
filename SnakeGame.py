...
class Snake(Canvas):
    ...
    def load_assets(self):
        self.snake_body_image = Image.open('./SnakeGameNokia3310/assets/body.png')
        self.snake_body = ImageTk.PhotoImage(self.snake_body_image)

        self.food_image = Image.open('./SnakeGameNokia3310/assets/food.png')
        self.food = ImageTk.PhotoImage(self.food_image)

    def create_objects(self):
        # create score text
        FONT = (None,14)
        self.create_text(45,12,text='Score: {}'.format(self.score),tag='score',fill='orange',font=FONT)
        ...
        self.create_rectangle(7,27,593,613,outline='#f5ed07')
    ...
    def move_snake(self):
        ...
        for segment, pos in zip(findsnake,self.snake_positions):
            # zip(findsnake,self.snake_positions) = [(segment1(120,100)),(segment1(120,100)),(segment1(120,100))]
...
GUI = Tk()
GUI.title('Snake Game by B1ackmonday')
